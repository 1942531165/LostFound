...
<?php
    ...
    echo "<script>let index = '$index';</script>";
?>
<body>
    <!-- 加载中 -->
    ...
    <div class="mdui-appbar-with-toolbar mdui-loaded">
        <div class="mdui-appbar mdui-appbar-fixed mdui-shadow-0">
            <div class="mdui-toolbar mdui-color-indigo">
                ...
                <a class="mdui-typo-headline mobile-title">修改物品信息</a>
                <div class="mdui-toolbar-spacer"></div>
                <a class="mdui-typo-headline pc-title">修改物品信息</a>
                <div class="mdui-toolbar-spacer"></div>
                <!-- 登录注册之后 -->
                <div>
                    <!-- pc端 -->
        ...
        <form enctype="multipart/form-data" class="edit" method="post">
            <div class="main">
                <div class="main-box reports">
                    ...
                    <div class="item">
                        <div class="troduce">
                            <div class="mdui-textfield">
                                <label class="mdui-textfield-label title">描述</label>
                        ...
                        <div class="thre">
                            ...
                            <div class="address">
                                <div class="mdui-textfield">
                                    <label class="mdui-textfield-label title">地点</label>
                            ...
                            <div class="time">
                                <div class="mdui-textfield">
                                    <label class="mdui-textfield-label title">时间</label>
                        ...
                        <div class="info">
                            <div class="mdui-textfield">
                                <label class="mdui-textfield-label title">详细信息</label>
                    ...
                    <div class="image-upload">
                        <label class="mdui-textfield-label title">特征照片</label>
                    ...
                    <div class="person">
                        ...
                        <div class="contact">
                            <div class="mdui-textfield">
                                <label class="mdui-textfield-label title">联系方式</label>
                    ...
                    <div class="btns">
                        <div class="back">
                            <button type="button" class="back-btn mdui-ripple">返回</button>
                        </div>
                        <div class="publish">
                            <button type="submit" class="publish-btn mdui-ripple mdui-color-indigo">修改信息</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="../js/report/edit.js"></script>
