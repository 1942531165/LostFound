    ...
    <div class="mdui-appbar-with-toolbar mdui-loaded">
        <div class="mdui-appbar mdui-appbar-fixed mdui-shadow-0">
            <div class="mdui-toolbar mdui-color-indigo">
                ...
                <a class="mdui-typo-headline mobile-title">发布寻物启事</a>
                <div class="mdui-toolbar-spacer"></div>
                <a class="mdui-typo-headline pc-title">发布寻物启事</a>
                <div class="mdui-toolbar-spacer"></div>
                <!-- 登录注册之后 -->
                <div>
                    <!-- pc端 -->
        ...
        <form enctype="multipart/form-data" class="upload-found" method="post">
            <div class="main">
                <div class="main-box reports">
                    ...
                    <div class="item">
                        ...
                        <div class="thre">
                            ...
                            <div class="address">
                                <div class="mdui-textfield">
                                    <label class="mdui-textfield-label title">拾获地点<span class="tips">*</span></label>
                                    <input class="mdui-textfield-input message" name="address" type="text" required />
                                </div>
                            </div>
                            <!-- 丢失时间 -->
                            <div class="time">
                                <div class="mdui-textfield">
                                    <label class="mdui-textfield-label title">拾获时间</label>
                    ...
                    <div class="image-upload">
                        <label class="mdui-textfield-label title">上传特征照片<span class="tips">*</span></label>
                    ...
                    <!-- 发布按钮 -->
                    <div class="publish">
                        <button class="publish-btn mdui-ripple mdui-color-indigo">发布寻物启事</button>
                    </div>
                </div>
            </div>
        </form>
